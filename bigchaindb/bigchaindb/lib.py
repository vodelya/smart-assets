...
class BigchainDB(object):
    ...
    def get_count_of_all_non_transferable_assets_for_public_key_of_same_type(self, public_key, asset_type):
        return backend.query.get_count_of_all_non_transferable_assets_for_public_key_of_same_type(self.connection, public_key, asset_type)  

    def get_count_of_functional_assets_for_public_key(self, public_key, asset_type):
        return backend.query.get_count_of_functional_assets_for_public_key(self.connection, public_key, asset_type)
    
    def get_count_of_assets_with_same_identifier_and_type(self, asset_identifier, asset_type):
        return backend.query.get_count_of_assets_with_same_identifier_and_type(self.connection, asset_identifier, asset_type)
