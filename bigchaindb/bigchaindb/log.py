...
DEFAULT_LOGGING_CONFIG = {
    ...
    "formatters": {
        ...
        "message-only": {"class": "logging.Formatter", "format": ("%(message)s"),},
    },
    "handlers": {
        "console": {
        ...
        "recovery": {
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(DEFAULT_LOG_DIR, "bigchaindb-recovery.log"),
            "mode": "w",
            "maxBytes": 209715200,
            "backupCount": 5,
            "formatter": "precise",
        ...
        "metrics": {
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(DEFAULT_LOG_DIR, "bigchaindb-metrics.log"),
            "mode": "w",
            "maxBytes": 209715200,
            "backupCount": 5,
    ...
    "loggers": {
        "recovery": {"handlers": ["recovery"], "level": logging.DEBUG,},
        "metrics": {"handlers": ["metrics"], "level": logging.DEBUG,},
    },
