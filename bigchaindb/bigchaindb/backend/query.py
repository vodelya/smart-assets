...
@singledispatch
def get_count_of_all_non_transferable_assets_for_public_key_of_same_type(connection, public_key, asset_type):
    """Retrieve all assets that are non-transferable and owned by the `public_key`.

    Args:
        connection: The database connection instance.
        public_key (str): The public key of the asset owner.

    Returns:
        An iterator of assets that match the criteria.
    """
    raise NotImplementedError

@singledispatch
def get_count_of_functional_assets_for_public_key(connection, public_key, asset_type):
    """Retrieve the count of functional assets of a specific type owned by the `public_key`.
    ...
    Returns:
        int: The count of assets that match the criteria.
    """
    raise NotImplementedError

@singledispatch
def get_count_of_assets_with_same_identifier_and_type(connection, asset_identifier, asset_type):
    """Retrieve the count of assets with the same identifier and type`.

    Args:
        connection: The database connection instance.
        asset_identifier (str): The identifier of the asset.
        asset_type (str): The type of the asset.
